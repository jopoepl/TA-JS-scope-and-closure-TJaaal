...
function main() {
  ...
  console.log(four); // error - four is not defined (since four was functions scoped)
  inner();
}

main();
console.log(one, two, three, four); // four is not defined (since four was functions scoped)
```
